...
// function Footer() {
//   return (
//     <nav className="navbar navbar-expand-md navbar-light bg-light text-center">
//       <span className="w-100">
//         {" "}
//         <small className="navbar-nav mx-auto mr-md-auto text-secondary rights"> All rights reserved @2020 </small>
//       </span>
//       <div className="justify-content-center w-100 abs-center-footer" id="navbar8">
//         <ul className="navbar-nav mx-auto ">
//           <li className="nav-item">
//             <Link className="foot-nav nav-link" to="/">
//               Home
//             </Link>
//           </li>
//           <li className="nav-item">
//             {" "}
//             <Link className="foot-nav nav-link" to="/box">
//               Box
//             </Link>
//           </li>
//           {/* <li className="nav-item">
//             <Link className="foot-nav nav-link" to="/aboutus">
//               ABOUT US
//             </Link>
//           </li>
//           <li className="nav-item">
//             <Link className="foot-nav  nav-link" to="/contact">
//               CONTACT US
//             </Link>
//           </li> */}
//         </ul>
...
//           <li className="nav-item">
//             <a href="https://github.com/Pjaycorp" className="nav-link">
//               <i className="fa  fa-github" aria-hidden="true"></i>
//             </a>
//           </li>
//           <li className="nav-item">
//             <a href="https://www.instagram.com/pjaycorp/" className="nav-link">
//               <i className="fa  fa-instagram" aria-hidden="true"></i>
//             </a>
//           </li>
//           <li className="nav-item">
//             <a href="https://www.facebook.com/pjaycorp/" className="nav-link">
//               <i className="fa  fa-facebook" aria-hidden="true"></i>
//             </a>
//           </li>
//           <li className="nav-item">
//             <a href="https://twitter.com/pjaycorp" className="nav-link">
//               <i className="fa  fa-twitter" aria-hidden="true"></i>
//             </a>
//           </li>
//           <li className="nav-item">
//             <a href={slack.Url ? slack.Url : "#"} className="nav-link">
//               <i className="fa  fa-slack" aria-hidden="true"></i>
//             </a>
//           </li>
//           <li className="nav-item">
//             <a href="https://discord.gg/VvZqSqX" className="nav-link">
//               <img className="discord" src="https://img.icons8.com/ios/42/b6b6b6/discord-logo.png" />
//             </a>
//           </li>
//         </ul>
//       </div> */}
...
function Footer() {
    return (
        <div>
        <footer id="footer" class="footer-1 footer mt-auto py-3">
        ...
        <h5 class="widget-title">QR Boxes<span></span></h5>
        <p>We help organize our cusotmers shipments and boxes through box id's, qr codes, and barcodes.</p>
        </div>
        </div>
        ...
        <p>You can get started at the home page of this site.</p>
        {/* <a class="btn footer-btn" href="#." target="_blank">Register Now</a> */}
        </div>
        </div>
        ...
        <p><a href="mailto:support@qrboxes.com" title="glorythemes">support@qrboxes.com</a></p>
        ...
        <p>Copyright QR Boxes © 2021. All rights reserved.</p>
        </div>
        </div>
        </div>
        </div>
